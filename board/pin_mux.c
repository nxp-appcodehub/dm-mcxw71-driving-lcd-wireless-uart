...
void I2C0_InitPins()
{
	...
	const port_pin_config_t portb5_pin_config = {/* Internal pull-up/down resistor is disabled */
													kPORT_PullUp,
	...
	/* PORTB5 */
	PORT_SetPinConfig(PORTB, 5U, &portb5_pin_config);

	const port_pin_config_t portb4_pin_config = {/* Internal pull-up/down resistor is disabled */
													kPORT_PullUp,
													/* Low internal pull resistor value is selected. */
													kPORT_HighPullResistor,
													/* Fast slew rate is configured */
													...
													kPORT_UnlockRegister};
	/* PORTB4 */
	PORT_SetPinConfig(PORTB, 4U, &portb4_pin_config);

}

void I2C0_DeinitPins()
{
	}

void BOARD_InitPins_SPI0(void)
{
    ...
    CLOCK_EnableClock(kCLOCK_GpioC);
        ...
        gpio_pin_config_t LPSPI1_PCS1_config = {
            .pinDirection = kGPIO_DigitalOutput,
            .outputLogic = 1U
        };
        /* Initialize GPIO functionality on pin PTB0 (pin 46)  */
        GPIO_PinInit(GPIOC, 6, &LPSPI1_PCS1_config);


    const port_pin_config_t portc6_pin_config = {/* Internal pull-up resistor is enabled */
													kPORT_PullUp,
                                                    /* Low internal pull resistor value is selected. */
                                                    ...
                                                    kPORT_UnlockRegister};
    /* PORTC6*/
    PORT_SetPinConfig(PORTC, 6U, &portc6_pin_config);


    gpio_pin_config_t LPSPI1_rst_config = {
        .pinDirection = kGPIO_DigitalOutput,
        .outputLogic = 1U
    };
    /* Initialize GPIO functionality on pin RST */
    GPIO_PinInit(GPIOC, 0, &LPSPI1_rst_config);


const port_pin_config_t portc0_pin_config = {/* Internal pull-up resistor is enabled */
												kPORT_PullUp,
                                                /* Low internal pull resistor value is selected. */
                                                kPORT_LowPullResistor,
                                                /* Fast slew rate is configured */
                                                ...
                                                kPORT_UnlockRegister};
/* PORTC0 */
PORT_SetPinConfig(PORTC, 0U, &portc0_pin_config);



    const port_pin_config_t portb1_pin_config = {/* Internal pull-up resistor is enabled */
													kPORT_PullUp,
                                                    /* Low internal pull resistor value is selected. */
                                                    kPORT_LowPullResistor,
                                                    /* Fast slew rate is configured */
                                                    ...
                                                    kPORT_UnlockRegister};
    /* PORTB1 */
    PORT_SetPinConfig(PORTB, 1U, &portb1_pin_config);

    const port_pin_config_t portb3_pin_config = {/* Internal pull-up resistor is enabled */
													kPORT_PullUp,
                                                    /* Low internal pull resistor value is selected. */
                                                    kPORT_LowPullResistor,
                                                    /* Fast slew rate is configured */
                                                    ...
                                                    kPORT_UnlockRegister};
    /* PORTB3*/
    PORT_SetPinConfig(PORTB, 3U, &portb3_pin_config);

    const port_pin_config_t portb2_pin_config = {/* Internal pull-up resistor is enabled */
													kPORT_PullUp,
                                                    /* Low internal pull resistor value is selected. */
                                                    kPORT_LowPullResistor,
                                                    /* Fast slew rate is configured */
                                                    ...
                                                    kPORT_UnlockRegister};
    /* PORTB2*/
    PORT_SetPinConfig(PORTB, 2U, &portb2_pin_config);

}

void BOARD_DeInitPins_SPI0(void)
{
