...
static void LPSPI_SetTransferConfigFlags(bool isMaster, uint32_t instance, lpspi_transfer_t *xfer)
{
    if (isMaster)
    {
        ...
        xfer->configFlags =
            (uint32_t)kLPSPI_MasterPcs1 | (uint32_t)kLPSPI_MasterByteSwap | (uint32_t)kLPSPI_MasterPcsContinuous;
    ...
    {
        /* Set default config flag */
        xfer->configFlags = (uint32_t)kLPSPI_SlavePcs1 | (uint32_t)kLPSPI_SlaveByteSwap;
...
static cmsis_lpspi_edma_resource_t LPSPI0_EdmaResource = {
	RTE_SPI0_DMA_TX_DMA_BASE,    RTE_SPI0_DMA_TX_CH,       28U,
    RTE_SPI0_DMA_RX_DMA_BASE,    RTE_SPI0_DMA_RX_CH,	   27U,
...
static cmsis_lpspi_edma_resource_t LPSPI1_EdmaResource = {
    RTE_SPI1_DMA_TX_DMA_BASE,    RTE_SPI1_DMA_TX_CH,          30,
    RTE_SPI1_DMA_RX_DMA_BASE,    RTE_SPI1_DMA_RX_CH,          29,
#if (defined(FSL_FEATURE_SOC_DMAMUX_COUNT) && FSL_FEATURE_SOC_DMAMUX_COUNT)
